...
jQuery(function ($) {
    ...
    } else if (/\/(?:channel|user)\/(.*?)(\?.*)?.*/.test(Settings.channel)) {
            ...
            if ($(this).find('i').text() !== 'star') {
                ...
                apiRequest("https://www.googleapis.com/youtube/v3/videos",{
                    ...
                    html = '<div class="col s12 m8 offset-m2 list" data-id="' + id + '">' +
                        ...
                        '<div class="watched-text"> Marked </div></div>' +
                    ...
                    $('a.waves-effect.waves-light.favorite-button[data-id="' + id + '"] .material-icons').html('star');
                ...
                $('a.waves-effect.waves-light.favorite-button[data-id="' + id + '"] .material-icons').html('star_border');
            }
        }
    }, ".favorite-button");
